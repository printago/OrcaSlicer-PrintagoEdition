...
//    DEV   // static constexpr std::string_view PRINTAGO_TOKEN_ENDPOINT = "http://dev.printago.io/token-validator";                // DEV //
static constexpr std::string_view PRINTAGO_TOKEN_ENDPOINT = "http://app.printago.io/token-validator"; //PRODUCTION//
